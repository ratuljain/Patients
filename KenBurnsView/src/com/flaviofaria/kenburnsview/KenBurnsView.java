...
public class KenBurnsView extends ImageView {
    ...
    /** The rect that holds the bounds of this com.example.lol.patients.view. */
            ...
            if (mDrawableRect.isEmpty()) {
                ...
                if (mCurrentTrans.getDestinyRect() != null) { // If null, it's supposed to stop.
                    ...
                    /* Performs matrix transformations to fit the content
                       of the current rect into the entire com.example.lol.patients.view. */
                    mMatrix.reset();
    ...
    public void restart() {
        ...
        if (width == 0 || height == 0) {
            throw new UnsupportedOperationException("Can't call restart() when com.example.lol.patients.view area is zero!");
        }
    ...
    /**
     * Checks whether this com.example.lol.patients.view has bounds.
     * @return
     */
    ...
    /**
     * Updates the viewport rect. This must be called every time the size of this com.example.lol.patients.view changes.
     ...
     * associated to this com.example.lol.patients.view changes.
     */
    ...
    private void handleImageChange() {
        ...
        /* Don't start a new transition if this event
         ...
         The com.example.lol.patients.view won't be ready at this time. Also,
         don't start it if this com.example.lol.patients.view size is still unknown. */
